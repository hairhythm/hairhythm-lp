...
const faqs = [
  ...
  {
    q: "開催場所はどこですか？",
    a: "その他全国どこでも出張いたします。空港・駅まで送迎いたします（新神戸駅から車で1時間、伊丹空港・神戸空港から車で1時間）。",
  },
  {
    q: "参加費用はいくらですか？",
  ...
  {
    q: "受講後のサポートはありますか？",
    a: "修了講習後のご相談は、電話やLINE、FBなどを通して、一生【無料】でさせていただきます。集客方法指導（チラシ・POPなど）、カウンセリング指導（随時）、抜け毛診断の指導、取扱い商品の知識・効果効能指導など幅広くサポートします。※修得講習後の訪問指導のみ、有料となります。",
  },
  {
    q: "修了証・ディプロマはもらえますか？",
