    ...
    >
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {[
            { url: MICROSCOPE_URL, title: "マイクロスコープ実習", desc: "250倍に拡大できるマイクロスコープで頭皮を診断。血流スコープ実習で頭皮・指・肌の血流も確認できます" },
